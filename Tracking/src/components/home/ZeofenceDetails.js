        ...
        <View className="w-full bg-cyan-400 h-screen">
            ...
            <View className="flex justify-center items-center my-5">
                <View className="flex flex-row align-middle justify-between w-[90%] pb-2">
                    <View className="">
                        <Text className=" font-bold sm:text-3xl md:text-3xl text-2xl text-white text-center ">Geofence Full Details</Text>
                    </View>
                    <View className="">
                        <Text className=" font-bold sm:text-3xl md:text-3xl text-2xl text-white text-center "><Button onPress={handleViewGeofence} title='View All' color="#fd453f" /></Text>
                    </View>
                </View>
            </View>
            <ScrollView>
                <View className="flex justify-center items-center">
                    <View className="w-[90%] bg-slate-100 shadow-lg p-5 rounded-xl mb-5">
                        <View className="flex flex-row align-middle justify-between">
                            <View>
                                <Text className="text-black text-2xl font-bold">COMPANY : DIZITAL DREAMS</Text>
                                <Text className="sm:text-xl md:text-xl text-lg text-slate-700">TYPE : DIZIBIZZ</Text>
                        ...
                        <View className="my-4 flex flex-col align-middle justify-between">
                            <Text className="font-bold w-100 mb-2 text-xl text-black">Latitude : </Text>
                            <Text className=" font-bold w-100 text-slate-700">23.23,234,2.422342.3.42,.232.,24</Text>
                        </View>
                        <View className="flex flex-col align-middle justify-between">
                            <Text className="font-bold w-100 mb-2 text-xl text-black">Longitude : </Text>
                            <Text className=" font-bold w-100 text-slate-700">234.234,.23,23.3,443.34,.334,34.34</Text>
                        </View>
                        <View className="my-4 flex flex-col align-middle justify-between">
                            <Text className="font-bold w-100 mb-2 text-xl text-black">Description : </Text>
                            <Text className=" font-bold w-100 text-slate-700">
                        ...
                        <View className="my-4 flex flex-col align-middle justify-between">
                            ...
                            <Text className="text-cyan-500 sm:text-xl md:text-xl text-md font-bold w-100">
                                Mango Traveler , Lucknow Vibhuti Khand D77 Building 3rd Floor 226010</Text>
                        </View>
                    </View>
                </View>
