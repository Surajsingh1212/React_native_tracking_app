...
const CreateTrip = ({ navigation }) => {
  ...
  return (
    <View className="flex-1">
      <CustomHeader title="CreateTrip" navigation={navigation} notificationCount={2} />
        ...
        <View className="bg-slate-50 shadow-xl w-[90%] rounded-3xl h-[80%] pb-8 pt-10 sm:pb-8 sm:pt-8 md:pb-8 md:pt-8">
          <ScrollView>
            ...
            <View className="px-10">
              ...
              <View>
                <TextInput placeholder="Select Trip End Date" className="rounded-xl py-4 bg-white ps-5 placeholder:text-slate-20 text-slate-700 px-2 my-2  w-[100%] placeholder:text-lg placeholder:px-4" />
              </View>
            </View>
            <View className="px-10">
            ...
            <View className="px-10">
              <View className="rounded-xl mt-4 w-100">
                <Button title="Create Now" onPress={handleCreateTrip} />
              </View>
            </View>
          </ScrollView>
        </View>
